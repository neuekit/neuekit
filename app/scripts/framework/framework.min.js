...
(function (UIKit, $) {
    ...
    UIKit.helper = function () {
        ...
        function Helper() {
            ...
            _this.getUrlQuery = function (key) {
            ...
            _this.init = function () {
                ...
                _this2.setDocClasses();

                _this2.setInputTypes();
...
(function (UIKit, $) {
    ...
    UIKit.tabs = function () {
        ...
        function Tabs() {
            ...
            var _this = this;
            var config = UIKit.settings.tabs;
                ...
                if (location.hash.substr(1) && $(location.hash).hasClass(config.tabContentClass)) {
                    ...
                    $('.' + config.tabsClass).each(function () {
                        ...
                        if ($(this).find('.' + config.tabActiveClass).length === 0) {
                            ...
                            var firstTab = $(this).find('.' + config.tabClass).eq(0);
            ...
            var tabClick = function tabClick(e) {
                ...
                var tabActive = $this.siblings('.' + config.tabActiveClass);
                var tabContentActive = tabContent.siblings('.' + config.tabContentActiveClass);
